...
-- -----------------------------------------------------
-- Table `sakila`.`tb_grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`tb_grupo` (
...
-- -----------------------------------------------------
-- Table `sakila`.`tb_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`tb_usuario` (
  ...
  CONSTRAINT `fk_tb_usuario_tb_grupo1`
    ...
    REFERENCES `sakila`.`tb_grupo` (`idGrupo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sakila`.`tb_postagem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`tb_postagem` (
  ...
  CONSTRAINT `fk_tb_postagem_tb_usuario1`
    ...
    REFERENCES `sakila`.`tb_usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
